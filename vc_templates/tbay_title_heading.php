...
<div class="<?php echo esc_attr($css_class);?>">
    ...
    <?php if(trim($linkbutton)!='' || trim($linkbutton2)!=''){ ?>
        <div class="clearfix action">
            ...
            <a class="btn btn-befo <?php echo esc_attr( $buttons ); ?>" href="<?php echo esc_url( $linkbutton ); ?>"> <?php echo esc_html( $textbutton ); ?> </a>
            <?php } ?>
            <?php if(trim($linkbutton2)!=''){ ?>
            <a class="btn btn-befo <?php echo esc_attr( $buttons2 ); ?>" href="<?php echo esc_url( $linkbutton2 ); ?>"> <?php echo esc_html( $textbutton2 ); ?> </a>
            <?php } ?>
        </div>
    <?php } ?>
</div>