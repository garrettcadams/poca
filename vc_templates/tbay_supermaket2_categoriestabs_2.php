    ...
    <div class="<?php echo esc_attr($css_class); ?>">
        ...
        <div class="widget-content woocommerce">
            ...
            <div class="row">
                ...
                <div class="no-padding-<?php echo (isset($padding)) ? esc_attr($padding) : ''; ?> pull-<?php echo (isset($banner_positions)) ? esc_attr($banner_positions) : ''; ?> text-<?php echo (isset($banner_positions)) ? esc_attr($banner_positions) : ''; ?>  vc_fluid col-md-4 tab-banner">
