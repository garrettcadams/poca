						...
						<span class="product-remove">
							<?php
								...
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									'<a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-product_sku="%s">&#215;</a>',
				...
				<div class="clearfix">
					<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon pull-left">
							<div class="box"><input type="text" name="coupon_code" id="coupon_code" value="" class="text" placeholder="<?php esc_html_e( 'Enter coupon code', 'puca' ); ?>" /><input type="submit" class="btn btn-default" name="apply_coupon" value="<?php esc_html_e( 'Apply', 'puca' ); ?>" /></div>
					...
					<?php if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
						<p class="continue-to-shop pull-right">
					...
					<div class="pull-right update">
						<input type="submit" class="btn btn-default" name="update_cart" value="<?php esc_html_e( 'Update Cart', 'puca' ); ?>" />
