	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
				...
				<div class="cart_item head">
					<span class="product"><?php esc_html_e( 'Product', 'puca' ); ?></span>
					<span class="product-name"></span>
					<span class="price"><?php esc_html_e( 'Price', 'puca' ); ?></span>
					<span class="quantity"><?php esc_html_e( 'Quantity', 'puca' ); ?></span>
					<span class="subtotal"><?php esc_html_e( 'Total', 'puca' ); ?></span>
			...
			<div class="cart-bottom clearfix actions">
				<?php if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
					<span class="continue-to-shop pull-left">
				...
				<?php endif; ?>
				<div class="pull-right update-cart">
					<input type="submit" class="btn btn-default update" name="update_cart" value="<?php esc_html_e( 'Update Cart', 'puca' ); ?>" />
		...
		<div class="col-md-3">
			...
			<div class="coupon">
				...
				<div class="box"><input type="text" name="coupon_code" id="coupon_code" value="" class="text" /><span class="input-group-btn"><input type="submit" class="btn btn-default" name="apply_coupon" value="<?php esc_html_e( 'Apply', 'puca' ); ?>" /></span></div>
