			...
			<div class="cart-bottom actions">
				...
				<?php if ( wc_coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<div class="box"><input type="text" name="coupon_code" id="coupon_code" value="" class="text" /><input type="submit" class="btn btn-default" name="apply_coupon" value="<?php esc_html_e( 'Apply', 'puca' ); ?>" /></div>
