...
if ( !function_exists ('puca_tbay_custom_styles') ) {
	function puca_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			.none-before .vc_general.vc_btn3, .vc_btn3-container .vc_general.vc_btn3, body table.compare-list .add-to-cart td .add-cart a {
			...
			.none-before .vc_general.vc_btn3:hover, .vc_btn3-container .vc_general.vc_btn3:hover, .vc_btn3-container .vc_general.vc_btn3:focus,
