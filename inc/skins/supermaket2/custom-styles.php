...
if ( !function_exists ('puca_tbay_custom_styles') ) {
	function puca_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			.widget_deals_products .product-block .add-cart .product_type_external, .widget_deals_products .product-block .add-cart .product_type_grouped, .widget_deals_products .product-block .add-cart .add_to_cart_button, .widget_deals_products .product-block .add-cart a.button, .widget_deals_products .product-block .add-cart a.added_to_cart,
			...
			.info-bottom,
			.tbay-to-top.totop-center #back-to-top i {
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			#tbay-header.header-v4 .logo-in-theme .category-inside-content li .hitarea:hover:after
			{
				color:<?php echo esc_html( puca_tbay_get_config('main_color') ) ?> !important;
			}
