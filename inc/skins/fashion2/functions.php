...
if ( !function_exists('puca_tbay_private_size_image_setup') ) {
	function puca_tbay_private_size_image_setup() {
		...
		*/
		...
		update_option('puca_avatar_post_carousel', 50, 50, true);
		add_image_size('puca_avatar_post_carousel', 50, 50, true); //(cropped)


		// Post Thumbnails Size
		set_post_thumbnail_size(570, 375, true); // Unlimited height, soft crop
...
if ( !function_exists('puca_fonts_url') ) {
	function puca_fonts_url() {
	    ...
	    */
	    $Playfair 		= _x( 'on', 'Playfair Display font: on or off', 'puca' );

	    $Josefin_Sans 		= _x( 'on', 'Josefin Sans font: on or off', 'puca' );
	 
	    if ( 'off' !== $Josefin_Sans || 'off' !== $Playfair ) {
	        $font_families = array(); 
	        ...
	        if ( 'off' !== $Josefin_Sans ) {
	            $font_families[] = 'Josefin+Sans:100,100i,300,300i,400,400i,600,600i,700,700i';
	        }
				...
				if( isset($blog_archive_layout) ) {
					...
					switch ( $blog_archive_layout ) {
							case 'main-v1':
						 		...
						 		break;							 	
						 	case 'main-v2':
						 		$configs['left'] = array( 'sidebar' => $left, 'class' => 'col-xs-12 col-md-3 col-lg-3'  );
						 		$configs['main'] = array( 'class' => 'style-grid archive-full style-center col-xs-12 col-md-9 col-lg-9' );
						 		$configs['columns'] 				= 1;
						 	...
						 	case 'left-main-v1':
						 		$configs['left'] = array( 'sidebar' => $left, 'class' => 'col-xs-12 col-md-3 col-lg-3'  );
						 		$configs['main'] 										= array( 'class' => 'style-grid col-xs-12 col-md-9 col-lg-9' );
						 		$configs['columns'] 								= 2;
						 		$configs['image_sizes'] 						= 'post-thumbnail';
						 		break;							 	
						 	case 'main-right-v1':
						 		$configs['right'] 			= array( 'sidebar' => $right,  'class' => 'col-xs-12 col-md-3 col-lg-3' ); 
						 		$configs['main'] 				= array( 'class' => 'style-grid col-xs-12 col-md-9 col-lg-9' );
						 		$configs['columns'] 				= 2;
						 		$configs['image_sizes'] 		= 'post-thumbnail';
						 		break;			
						 	case 'left-main-v2':
						 		$configs['left'] 						= array( 'sidebar' => $left, 'class' => 'col-xs-12 col-md-3 col-lg-3'  );
						 		$configs['main'] 						= array( 'class' => 'style-grid style-center col-xs-12 col-md-9 col-lg-9' );
						 		$configs['columns'] 				= 1;
						 		$configs['image_sizes'] 		= 'full';
						 		break;		
						 	case 'main-right-v2':
						 	...
						 	case 'left-main-v3':
						 		$configs['left'] 						= array( 'sidebar' => $left, 'class' => 'col-xs-12 col-md-3 col-lg-3'  );
						 		$configs['main'] 						= array( 'class' => 'style-list col-xs-12 col-md-9 col-lg-9' );
						 		$configs['columns'] 				= 1;
						 		$configs['image_sizes'] 		= 'post-thumbnail';
						 		break;		
						 	case 'main-right-v3':
								...
								break;
						 	case 'left-main-v4':
						 		$configs['left'] 						= array( 'sidebar' => $left2, 'class' => 'col-xs-12 col-md-3 col-lg-3'  );
						 		$configs['main']	 						= array( 'class' => 'style-gird col-xs-12 col-md-9 col-lg-9' );
						 		...
						 		break;		
						 	case 'main-right-v4':
						 		$configs['right'] 						= array( 'sidebar' => $right2,  'class' => 'col-xs-12 col-md-3 col-lg-3' ); 
						 		$configs['main'] 							= array( 'class' => 'style-gird col-xs-12 col-md-9 col-lg-9' );
						 		$configs['blog_top_sidebar1'] 	= true;
						 		$configs['blog_top_search'] 	= true;
						 		$configs['columns'] 					= 2;
						 	...
						 	case 'left-main-v5':
						 		$configs['left'] 							= array( 'sidebar' => $left2, 'class' => 'col-xs-12 col-md-3 col-lg-3'  );
						 		$configs['main'] 							= array( 'class' => 'col-xs-12 col-md-9 col-lg-9' );
...
if ( !function_exists('puca_custom_post_category') ) {
	function puca_custom_post_category () {
		  $post_category = "";
	  ...
	  if($categories){
	    foreach($categories as $category) {
	  	...
	  	$post_category = '<div class="entry-category">'. trim($output, $separator).'</div>';
	  }      
