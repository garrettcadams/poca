...
if ( !function_exists ('puca_tbay_custom_styles') ) {
	function puca_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			#tbay-header.header-v8 .tbay-mainmenu button.btn-toggle-canvas:hover
			{
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			.woo-variation-swatches-stylesheet-enabled .variable-item.button-variable-item.selected, .woo-variation-swatches-stylesheet-enabled .variable-item.button-variable-item:hover {
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?> ;
			...
			.widget_tbay_popup_newsletter .input-group-btn .form-control-feedback {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			.entry-date a,
			...
			.product-block.list .yith-wcwl-wishlistexistsbrowse.show a, .product-block.list .yith-wcwl-wishlistaddedbrowse.show a {
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>  !important;
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>  !important;
			}
