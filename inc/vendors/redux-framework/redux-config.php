                ...
                'fields' => array(          
                    array(
                        ...
                        'options'  => array(
                            ...
                            'Save {percent-diff}%' => esc_html__('Save {percent-diff}%' ,'puca'),
                            'Save ${price-diff}' => esc_html__('Save ${price-diff}' ,'puca'),
                            'custom' => esc_html__('Custom tag (use field below)' ,'puca')
                        ),
                        'default' => 'custom'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'subtitle' => esc_html__('Redirect add to cart to page cart on mobile (Single Product Page)', 'puca'),
                        'default' => false
                    ),                     
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array (
                        ...
                        'subtitle' => esc_html__('Minified version of functions.js and device.js file will be loaded', 'puca'),
                        'default' => true
                    ),
                )
            );
