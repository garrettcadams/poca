	...
	function puca_tbay_load_load_theme_element() {
		...
		vc_map( array(
			...
			"params"      => array(
				...
				array(
					"type" => "dropdown",
					"heading" => esc_html__('Button Style', 'puca'),
					"param_name" => "buttons",
					'value' 	=> array(
						esc_html__('Default Outline', 'puca') => 'btn-default btn-outline', 
						esc_html__('Primary Outline', 'puca') => 'btn-primary btn-outline', 
						esc_html__('Lighten', 'puca') => 'btn-lighten'
					),
					'std' => ''
				),
