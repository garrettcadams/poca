...
*/
if ( !function_exists('puca_tbay_change_bootstrap_class')) {
	function puca_tbay_change_bootstrap_class( $class_string, $tag ) {
...
add_filter( 'vc_shortcodes_css_class', 'puca_tbay_change_bootstrap_class', 10, 2 );
