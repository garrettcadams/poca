			...
			<div id="primary" class="content-area">
				<div id="content" class="site-content" role="main">
				 ...
				 if ( is_singular( 'product' ) ) {
		            ...
		            <?php if ( is_search() || ( apply_filters( 'woocommerce_show_page_title', true ) && puca_tbay_get_config('enable_cat_title_des_img', true) ) ) : ?>
		            ...
		            <?php
		            	...
		            	if( puca_tbay_get_config('enable_cat_title_des_img', true) ) {  
